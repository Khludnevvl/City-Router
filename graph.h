...
public:
    ...
    void SetIncidenceLists(std::vector<IncidenceList> incidence_lists)
    {
    ...
    const std::vector<IncidenceList> &GetIncedenceLists() const;
...
template <typename Weight>
const std::vector<std::vector<EdgeId>> &DirectedWeightedGraph<Weight>::GetIncedenceLists() const
{
